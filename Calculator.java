...
public class Calculator
{
    ...
    {
        //FIX the line below!   I have fixed it and it works now.
        return a - b;
    }
    ...
    // because the subtract() method is incomplete.  Fix it!  I have fixed it.
    ...
    // because the multiply() method is incomplete.  Fix it!  I have fixed it.
    ...
    // I am making up two division problems and creating print statements.

    //float y = divide(9,3); I could choose to use this for another step for the print
    // statement, but instead I chose to include it all in one print line.
